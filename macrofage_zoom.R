...
setwd("D:/Michael/git_check/atteno_macrofage")
...
macrofages <- FindClusters(macrofages, resolution = 0.35) #M# 6.1.25 choose madafaka
...
macrofages <- SetIdent(macrofages, value = "Sample") #M# change back to seurat clusters ?
